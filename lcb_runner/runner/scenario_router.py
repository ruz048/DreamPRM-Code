...
from lcb_runner.benchmarks import (
    ...
    load_funprm_reasoning_state_dataset
)
...
def build_prompt_benchmark(
    ...
    if scenario == Scenario.codegeneration:
        ...
        if args.generate_funprm_training_data:
            benchmark = load_funprm_reasoning_state_dataset(
                args.generate_funprm_training_data,
